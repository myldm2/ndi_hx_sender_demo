...
@interface MAPeelVideoWindowController ()

@end

@implementation MAPeelVideoWindowController
...
- (int)myPeelVideo:(NSString*)videoPath targetPath:(NSString*)targetPath
{
    return 0;
}
                          ...
                          const uint8_t *in, uint32_t in_size)
{
    ...
    if (!offset) {
//        NSLog(@"mayinglun log:try:%d", sps_pps_size);
...
//    if (sps_pps_size > 0)
//    {
//        [string appendString:@"sps_pps "];
//    }
//    if (!offset)
//    {
//        [string appendString:@"0001 "];
//    } else {
//        [string appendString:@"0010 "];
//    }
//    if (in_size > 0)
//    {
...
//    }
//
//    NSLog(@"mayinglun log ccc:%@", string);
...
//        NSLog(@"mayinglun log: unit_nb:%d unit_size:%d extra:%d", unit_nb, unit_size, codec_extradata_size);
...
//    NSLog(@"mayinglun log: total_size:%d", total_size);
...
//            NSLog(@"mayinglun log 1:%d", out->size);
...
//            if (out->size > 0)
//            {
//                NSLog(@"mayinglun log 2.1");
//            } else {
//                NSLog(@"mayinglun log 2.2");
//            }
            
            if ((ret=alloc_and_copy(out, NULL, 0, buf, nal_size)) < 0)
                goto fail;
//            NSData *data = [[NSData alloc] initWithBytes:out->data length:out->size];
//            NSLog(@"%@", data);
            /*
...
//    }
//
//    NSString *targetPath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"Test/test.mp4"];
...
//    }
    ...
    NSString *targetPath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"Test/test.h264"];
